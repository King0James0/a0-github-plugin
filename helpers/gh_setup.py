...
# clean_env: least-privilege env for spawned subprocesses (they must NOT inherit A0's runtime secrets).
...
def ensure_wrapper() -> bool:
    ...
    script = (
        ...
        f"SECRETS_FILE={shlex.quote(secrets_file)}\n"
        f"SECRET_KEY={shlex.quote(key)}\n"
